...
describe("Exctract group id from url", () => {
  it("Should return group id from group dashboard path", () => {
    expect(extractGroupId("/secure/groups/1/dashboard")).toEqual("1")
  })
  it("Should return group id from group courses path", () => {
    expect(extractGroupId("/secure/groups/1/courses")).toEqual("1")
  })
  it("Should return group id from group teacher files path", () => {
    expect(extractGroupId("/secure/groups/1/teacher/files")).toEqual("1")
  })
  ...
  it("Should return null from admin group path", () => {
    expect(extractGroupId("/secure/admin/groups/1")).toBeNull()
  })
})
